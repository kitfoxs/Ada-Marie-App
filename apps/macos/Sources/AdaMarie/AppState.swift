...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = AdaMarieConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = AdaMarieConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = AdaMarieConfigFile.loadDict()
            ...
            AdaMarieConfigFile.saveDict(root)
        }
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/adamarie"
        state.remoteCliPath = ""
        return state
    }
}
