...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.adamarie", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.adamarie", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [AdaMarieChatMessage] = messages.compactMap { item in
