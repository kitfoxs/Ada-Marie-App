...
enum UIStrings {
    static let welcomeTitle = "Welcome to AdaMarie"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "adamarie.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: AdaMarieOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: AdaMarieChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g adamarie@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: AdaMarieChatViewModel(
