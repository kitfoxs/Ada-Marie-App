...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .adamarieSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? AdaMariePaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? AdaMariePaths.stateDirURL.path
...
extension Notification.Name {
    static let adamarieSelectSettingsTab = Notification.Name("adamarieSelectSettingsTab")
}
