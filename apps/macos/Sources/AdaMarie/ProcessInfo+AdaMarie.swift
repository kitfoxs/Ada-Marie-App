...
extension ProcessInfo {
    ...
    /// Nix deployments may write defaults into a stable suite (`ai.adamarie.mac`) even if the shipped
    ...
    static func resolveNixMode(
        ...
        if standard.bool(forKey: "adamarie.nixMode") { return true }
        ...
        if isAppBundle, let stableSuite, stableSuite.bool(forKey: "adamarie.nixMode") { return true }
