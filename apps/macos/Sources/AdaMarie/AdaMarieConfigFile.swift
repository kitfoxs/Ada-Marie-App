...
enum AdaMarieConfigFile {
    private static let logger = Logger(subsystem: "ai.adamarie", category: "config")
    ...
    static func stateDirURL() -> URL {
        AdaMariePaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        AdaMariePaths.workspaceURL
    }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-adamarie-config-file",
            "event": "config.write",
