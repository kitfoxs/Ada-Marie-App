...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.adamarie", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other AdaMarie windows, but below the system’s pop-up menus.
