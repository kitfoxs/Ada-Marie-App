...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.adamarie", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".adamarie/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.adamarieCommand(
            subcommand: "gateway",
