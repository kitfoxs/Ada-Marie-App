...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.adamarie", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return AdaMarieConfigFile.defaultWorkspaceURL() }
