...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/adamarie/adamarie") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/adamarie/adamarie")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://adamarie.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
                (Bundle.main.object(forInfoDictionaryKey: "AdaMarieBuildTimestamp") as? String) ??
                (Bundle.main.object(forInfoDictionaryKey: "AdaMarieBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "AdaMarieGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "AdaMarieGitCommit") as? String) ??
            "unknown"
    }
