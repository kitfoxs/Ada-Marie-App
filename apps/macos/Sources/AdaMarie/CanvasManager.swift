...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.adamarie", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("AdaMarie/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__adamarie__/a2ui/").absoluteString + "?platform=macos"
    }
