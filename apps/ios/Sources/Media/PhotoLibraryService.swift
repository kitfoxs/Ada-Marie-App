...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: AdaMariePhotosLatestParams) async throws -> AdaMariePhotosLatestPayload {
        ...
        var results: [AdaMariePhotoPayload] = []
        ...
        return AdaMariePhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> AdaMariePhotoPayload
    {
