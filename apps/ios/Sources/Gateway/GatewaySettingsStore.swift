...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.adamarie.gateway"
    private static let nodeService = "ai.adamarie.node"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.adamarie.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.adamarie.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .documentDirectory, in: .userDomainMask).first?
            .appendingPathComponent("adamarie-gateway.log")
    }
