...
struct SettingsTab: View {
    ...
    @AppStorage("location.enabledMode") private var locationEnabledModeRaw: String = AdaMarieLocationMode.off.rawValue
    ...
    @State private var lastLocationModeRaw: String = AdaMarieLocationMode.off.rawValue
    ...
    private let gatewayLogger = Logger(subsystem: "ai.adamarie.ios", category: "GatewaySettings")
    ...
    var body: some View {
        NavigationStack {
                ...
                Section("Device") {
                    DisclosureGroup("Features") {
                        ...
                        Picker("Location Access", selection: self.$locationEnabledModeRaw) {
                            Text("Off").tag(AdaMarieLocationMode.off.rawValue)
                            Text("While Using").tag(AdaMarieLocationMode.whileUsing.rawValue)
                            Text("Always").tag(AdaMarieLocationMode.always.rawValue)
                        }
                        ...
                        Text("Keeps the screen awake while AdaMarie is open.")
                            .font(.footnote)
                            .foregroundStyle(.secondary)
                    }
            ...
            .onChange(of: self.locationEnabledModeRaw) { _, newValue in
                ...
                guard let mode = AdaMarieLocationMode(rawValue: newValue) else { return }
                Task {
    ...
    private var locationMode: AdaMarieLocationMode {
        AdaMarieLocationMode(rawValue: self.locationEnabledModeRaw) ?? .off
    }
