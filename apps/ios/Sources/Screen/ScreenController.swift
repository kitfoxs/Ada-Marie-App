...
final class ScreenController {
    ...
    /// Callback invoked when an adamarie:// deep link is tapped in the canvas
    ...
    private static func bundledResourceURL(
        ...
        -> URL?
    {
        let bundle = AdaMarieKitResources.bundle
...
/// Handles navigation policy to intercept adamarie:// deep links from canvas
@MainActor
private final class ScreenNavigationDelegate: NSObject, WKNavigationDelegate {
        ...
        decisionHandler: @escaping @MainActor @Sendable (WKNavigationActionPolicy) -> Void)
    {
        ...
        // Intercept adamarie:// deep links.
        if url.scheme?.lowercased() == "adamarie" {
