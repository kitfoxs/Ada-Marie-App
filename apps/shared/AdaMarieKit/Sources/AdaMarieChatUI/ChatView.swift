...
@MainActor
public struct AdaMarieChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: AdaMarieChatViewModel
    ...
    public init(
        viewModel: AdaMarieChatViewModel,
    ...
    private var visibleMessages: [AdaMarieChatMessage] {
        let base: [AdaMarieChatMessage]
    ...
    private func mergeToolResults(in messages: [AdaMarieChatMessage]) -> [AdaMarieChatMessage] {
        ...
        for message in messages {
            ...
            let merged = AdaMarieChatMessage(
                id: last.id,
                role: last.role,
                content: content,
    ...
    private func isToolResultMessage(_ message: AdaMarieChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: AdaMarieChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: AdaMarieChatMessage) -> String {
