...
public typealias AdaMariePlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias AdaMariePlatformImage = UIImage
#endif

public struct AdaMarieChatUsageCost: Codable, Hashable, Sendable {
...
public struct AdaMarieChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: AdaMarieChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(AdaMarieChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct AdaMarieChatMessageContent: Codable, Hashable, Sendable {
...
public struct AdaMarieChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [AdaMarieChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: AdaMarieChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [AdaMarieChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: AdaMarieChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(AdaMarieChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([AdaMarieChatMessageContent].self, forKey: .content) {
...
public struct AdaMarieChatHistoryPayload: Codable, Sendable {
...
public struct AdaMarieSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct AdaMarieSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [AdaMarieSessionPreviewItem]
}

public struct AdaMarieSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [AdaMarieSessionPreviewEntry]

    public init(ts: Int, previews: [AdaMarieSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct AdaMarieChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct AdaMarieChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct AdaMarieAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct AdaMarieChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct AdaMarieGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct AdaMariePendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: AdaMariePlatformImage?
...
public struct AdaMarieChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
