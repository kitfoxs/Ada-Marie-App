...
public enum AdaMarieCanvasA2UICommand: String, Codable, Sendable {
...
public struct AdaMarieCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct AdaMarieCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
