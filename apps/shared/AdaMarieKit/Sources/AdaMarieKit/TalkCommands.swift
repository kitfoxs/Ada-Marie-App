...
public enum AdaMarieTalkCommand: String, Codable, Sendable {
...
public struct AdaMarieTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct AdaMarieTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
